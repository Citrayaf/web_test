$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Pernikahan Lulu dan Afa",

            // Event start date
            start: new Date('May 18, 2023 09:00'),
            ...
            end: new Date('May 18, 2023 15:00'),
            ...
            // Event Description
            description: "Kami tidak sabar untuk melihat Anda di hari besar kami. Untuk pertanyaan atau masalah apa pun, silakan hubungi  ."
        }
    });     
...
// Google map
function initMap() {
    var location = {lat: -7.076905239888267, lng: 110.91515913144426};
...
function initBBSRMap() {
    var la_fiesta = {lat: -7.076905239888267, lng: 110.91515913144426};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
